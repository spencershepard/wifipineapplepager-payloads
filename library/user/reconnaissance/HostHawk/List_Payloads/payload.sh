#!/bin/bash
# Title: List Payloads
# Description: Lists all available HostHawk payloads from configuration files
...
LOG "Scanning HostHawk payload configurations..."
...
LOG purple "═══════════════════════════════════════════"
LOG purple "HostHawk Payload Catalog"
LOG purple "═══════════════════════════════════════════"
